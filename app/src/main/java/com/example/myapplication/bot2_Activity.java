...
public class bot2_Activity extends AppCompatActivity {
    LineChart lineChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bot2_);
        ...
        MarkerView mv = new markerview2(this,R.layout.markerview);
        ...
        getSupportActionBar().setTitle("Dust Density");
        ...
        mref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    String SV =ds.child("dustdensity").getValue().toString();
                ...
                final LineDataSet lineDataSet = new LineDataSet(datavalues, "DustDensity");
