...
public class bot0_Activity extends AppCompatActivity {
    LineChart lineChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bot0_);

        lineChart = findViewById(R.id.linechart0);
        ...
        MarkerView mv = new markerview0(this,R.layout.markerview);
        ...
        mref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                s++;
                final LineDataSet lineDataSet = new LineDataSet(datavalues, "Temperature");
